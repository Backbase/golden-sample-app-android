...
import com.backbase.custom_authentication_flow.otp_verify.presentation.OtpInputViewModel
...
fun customAuthFlowModule() = module {
    ...
    viewModel { OtpInputViewModel(get<AuthFlowUseCaseManager>().otpInputRouterUseCase, get(), get()) }
}